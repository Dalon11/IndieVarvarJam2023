	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float4 tex2DNode14 = tex2D( _TextureSample0, texCoord9 );
				float4 temp_output_13_0 = ( tex2DNode14 * IN.ase_color * _Emm );
...
ASEEND*/
//CHKSM=7CE25AC56D6DA86DEDB615ABC8000876D3B0E04F