...
Shader "Fair"
{
	Properties
	{
		...
		_Scale("Scale", Float) = 3.62
		_Speed("Speed", Vector) = (0,-0.37,0,0)
		_Speed1("Speed", Vector) = (0.15,-0.37,0,0)
		_Float1("Float 1", Float) = 3.45
		_Emm("Emm", Float) = 8.31
	...
	LOD 0
		...
		Pass
		{
				...
				) : SV_Target
			{
				...
				float2 texCoord13 = IN.ase_texcoord9.xy * float2( 1,1 ) + float2( 0,0 );
				float2 texCoord8 = IN.ase_texcoord9.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner7 = ( 1.0 * _Time.y * _Speed + texCoord8);
				float simplePerlin2D10 = snoise( panner7*_Scale );
				simplePerlin2D10 = simplePerlin2D10*0.5 + 0.5;
				float2 temp_cast_0 = (simplePerlin2D10).xx;
				float2 lerpResult12 = lerp( texCoord13 , temp_cast_0 , -0.18);
				float time15 = 0.0;
				float2 voronoiSmoothId15 = 0;
				float2 panner19 = ( 1.0 * _Time.y * _Speed1 + texCoord8);
				float2 coords15 = panner19 * _Float1;
				float2 id15 = 0;
				float2 uv15 = 0;
				float voroi15 = voronoi15( coords15, time15, id15, uv15, 0, voronoiSmoothId15 );
				float4 temp_output_22_0 = ( ( tex2D( _TextureSample0, lerpResult12 ) * ( simplePerlin2D10 * pow( voroi15 , 1.51 ) ) ) * _Emm * IN.ase_color * _Color0 );
...
Node;AmplifyShaderEditor.NoiseGeneratorNode;10;-845.6938,56.74158;Inherit;True;Simplex2D;True;False;2;0;FLOAT2;0,0;False;1;FLOAT;4.14;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;11;-1038.094,206.2416;Inherit;False;Property;_Scale;Scale;1;0;Create;True;0;0;0;False;0;False;3.62;2.21;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;12;-364.6936,-73.25847;Inherit;True;3;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;8;-1607.494,-1.758364;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TextureCoordinatesNode;13;-1101.791,-287.7582;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;14;-541.4918,228.3418;Inherit;False;Constant;_Float0;Float 0;3;0;Create;True;0;0;0;False;0;False;-0.18;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;6;91.2,-99.90002;Inherit;True;Property;_TextureSample0;Texture Sample 0;0;0;Create;True;0;0;0;False;0;False;-1;98c66768ecf346342a634d8a77a9575e;98c66768ecf346342a634d8a77a9575e;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.VoronoiNode;15;-742.9913,535.1415;Inherit;True;0;0;1;0;1;False;1;False;False;False;4;0;FLOAT2;0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;3;FLOAT;0;FLOAT2;1;FLOAT2;2
Node;AmplifyShaderEditor.RangedFloatNode;16;-1005.591,598.8417;Inherit;False;Property;_Float1;Float 1;4;0;Create;True;0;0;0;False;0;False;3.45;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;17;-221.691,533.8417;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;18;-506.391,554.6417;Inherit;True;False;2;0;FLOAT;0;False;1;FLOAT;1.51;False;1;FLOAT;0
Node;AmplifyShaderEditor.PannerNode;7;-1191.494,59.34161;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.Vector2Node;9;-1500.894,158.1416;Inherit;False;Property;_Speed;Speed;2;0;Create;True;0;0;0;False;0;False;0,-0.37;0,-0.37;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.PannerNode;19;-1023.791,329.7417;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.Vector2Node;20;-1333.191,428.5417;Inherit;False;Property;_Speed1;Speed;3;0;Create;True;0;0;0;False;0;False;0.15,-0.37;0,-0.37;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;21;417.91,312.8417;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;22;713.0098,282.9417;Inherit;True;4;4;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.VertexColorNode;24;468.6099,776.9418;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;1230.4,206.8;Float;False;True;-1;2;ASEMaterialInspector;0;4;Fair;ed95fe726fd7b4644bb42f4d1ddd2bcd;True;ForwardBase;0;1;ForwardBase;18;False;True;0;1;False;;0;False;;0;1;False;;0;False;;True;0;False;;0;False;;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;2;False;;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;2;False;;True;3;False;;False;True;3;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;DisableBatching=False=DisableBatching;True;2;False;0;False;True;1;5;False;;10;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=ForwardBase;False;False;0;;0;0;Standard;40;Workflow,InvertActionOnDeselection;1;0;Surface;1;638303334680248694;  Blend;0;0;  Refraction Model;0;0;  Dither Shadows;1;0;Two Sided;0;638303341968094265;Deferred Pass;1;0;Transmission;0;0;  Transmission Shadow;0.5,False,;0;Translucency;0;0;  Translucency Strength;1,False,;0;  Normal Distortion;0.5,False,;0;  Scattering;2,False,;0;  Direct;0.9,False,;0;  Ambient;0.1,False,;0;  Shadow;0.5,False,;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;Ambient Light;1;0;Meta Pass;1;0;Add Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Fwd Specular Highlights Toggle;0;0;Fwd Reflections Toggle;0;0;Disable Batching;0;0;Vertex Position,InvertActionOnDeselection;1;0;0;6;False;True;True;True;True;True;False;;False;0
Node;AmplifyShaderEditor.RangedFloatNode;23;415.3098,594.9417;Inherit;False;Property;_Emm;Emm;5;0;Create;True;0;0;0;False;0;False;8.31;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;25;482.9098,1112.342;Inherit;False;Property;_Color0;Color 0;6;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=6689DBA228D1874054F305BCB305DF3E91EBCF1F